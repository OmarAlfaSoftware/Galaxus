...
//                s.Header != null && s.Header.Metadata != null
//                    ? (s.Header..Metadata.OrderId ?? s.Header.Metadata.DocumentId)
//                    : null))
//            .ForMember(d => d.CustOrderId, opt => opt.MapFrom(s =>
//                s.Header != null && s.Header.Metadata != null && s.Header.Metadata.CustomerOrderReference != null
//                    ? s.Header.Metadata.CustomerOrderReference.OrderId
//                    : null))
//            .ForMember(d => d.OrderDate, opt => opt.MapFrom(s =>
//                s.Header != null && s.Header.Metadata != null
//                    ? (s.Header.Metadata.OrderDate ?? s.Header.Metadata.DocumentDate ?? DateTime.MinValue)
//                    : DateTime.MinValue))
//            .ForMember(d => d.Language, opt => opt.MapFrom(s =>
//                s.Header != null && s.Header.Metadata != null ? s.Header.Metadata.Language : null))
//            .ForMember(d => d.BuyerId, opt => opt.MapFrom(s =>
//                s.Header != null && s.Header.Metadata != null && s.Header.Metadata.OrderPartiesReference != null
//                    ? s.Header.Metadata.OrderPartiesReference.BuyerIdRef
//                    : null))
//            .ForMember(d => d.SupplierId, opt => opt.MapFrom(s =>
//                s.Header != null && s.Header.Metadata != null && s.Header.Metadata.OrderPartiesReference != null
//                    ? s.Header.Metadata.OrderPartiesReference.SupplierIdRef
//                    : null))
...
//                s.Header != null && s.Header.Metadata != null ? s.Header.Metadata.Currency : null))
//            .ForMember(d => d.HeaderUDX, opt => opt.MapFrom(s =>
//                s.Header != null && s.Header.Metadata != null ? s.Header.Metadata.HeaderUDX : null))
//            .ForMember(d => d.Parties, opt => opt.MapFrom(s =>
//                s.Header != null && s.Header.Metadata != null && s.Header.Metadata.Parties != null
//                    ? s.Header.Metadata.Parties
//                    : new()))
...
//            .ForMember(d => d.OrderInfo, opt => opt.MapFrom(s => s.Metadata));
